...
def get_movie_recommendation(rating) :
    if rating >= 9 :
        print('Recommended movie:', movies[0])
    elif rating >= 8 and rating < 9 :
        print('Recommended movie:', movies[1])
    elif rating >= 7 and rating < 8 :
        print('Recommended movie:', movies[2])
    else :
        print('Recommended movie :', movies[3])

get_movie_recommendation(rating = int(input('Enter your movie rating (0-10): ')))
